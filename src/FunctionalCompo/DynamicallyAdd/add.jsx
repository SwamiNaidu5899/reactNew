...
const CrudOnAvng = () => {
  ...
  const addAvenger = () => {
   ...
   if((inpEl) !=='' ) {  const newAvengers = [...avengers, inpEl];
   setAvengers(newAvengers)
   }
    else 
     alert("input field should be required dude..")
  };
  ...
  return (
    <div className="container">
      <form action="">
        <input type="text" ref={inpElRef} name="" id="" placeholder='Add or Update'/>
      </form>
      <button id='btn' onClick={addAvenger}>Add</button>
